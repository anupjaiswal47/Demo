  ...
  var game = {
    ...
    loop: function () {
      ...
      if(!stopped) {
        ...
        ctx.font = "small-caps 24px Helvetica";
        ctx.fillText("(esc) reset", 36, 356);
        ctx.fillText("(space) pause", 36, 374);
      }
      ...
      if(stopped) {
        ...
        ctx.font = "small-caps bold 30px Helvetica";
        ctx.fillText("press ARROW KEYS to START...", 24, 374);
      }

      ctx.fillStyle = 'white';
      ctx.font = "bold small-caps 32px Helvetica";
